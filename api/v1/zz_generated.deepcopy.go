...
func (in *ChainVersion) DeepCopyInto(out *ChainVersion) {
	*out = *in
	...
	if in.UpgradeDelaySeconds != nil {
		in, out := &in.UpgradeDelaySeconds, &out.UpgradeDelaySeconds
		*out = new(uint32)
		**out = **in
	}
}
...
func (in *FullNodeStatus) DeepCopyInto(out *FullNodeStatus) {
	*out = *in
	...
	if in.UpgradeDelay != nil {
		in, out := &in.UpgradeDelay, &out.UpgradeDelay
		*out = make(map[string]*UpgradeDelayInfo, len(*in))
		for key, val := range *in {
			var outVal *UpgradeDelayInfo
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
				in, out := &inVal, &outVal
				*out = new(UpgradeDelayInfo)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpgradeDelayInfo) DeepCopyInto(out *UpgradeDelayInfo) {
	*out = *in
	in.Timestamp.DeepCopyInto(&out.Timestamp)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpgradeDelayInfo.
func (in *UpgradeDelayInfo) DeepCopy() *UpgradeDelayInfo {
	if in == nil {
		return nil
	}
	out := new(UpgradeDelayInfo)
